  ...
  allProjects = [
    ...
    },
    {
      ...
      description: 'The program includes text fields for\n' +
        ' entering details, add information, and a display area to showcase the entered data. Deals with the\n' +
        ' maintenance of admin & Client information within the Company.',
